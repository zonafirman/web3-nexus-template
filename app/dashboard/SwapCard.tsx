    ...
    <div className="p-6 md:p-8 rounded-[2.5rem] bg-zinc-900/60 border border-white/10 backdrop-blur-2xl shadow-2xl relative overflow-hidden h-full flex flex-col">
      ...
      <div className="space-y-2 relative">
        ...
        <div className="p-6 rounded-[1.5rem] bg-zinc-950 border border-white/5 group focus-within:border-cyan-500/50 transition-all">
          ...
          <div className="flex items-center gap-4">
            <input 
              ...
              className="bg-transparent border-none outline-none text-3xl font-black text-white w-full placeholder-zinc-800"
            />
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 z-10">
          <button className="p-3 rounded-2xl bg-zinc-900 border-4 border-zinc-950 text-cyan-500 hover:scale-110 active:scale-95 transition-all shadow-xl">
        ...
        <div className="p-6 rounded-[1.5rem] bg-zinc-950 border border-white/5 group transition-all">
          ...
          <div className="flex items-center gap-4">
            <div className="text-3xl font-black text-zinc-700 w-full select-none">
              {amount ? (parseFloat(amount) * 3420.50).toLocaleString() : '0.00'}
            </div>
            <button className="flex items-center gap-2 p-2 px-3 rounded-2xl bg-zinc-900 border border-white/10 hover:bg-zinc-800 transition-colors">
      ...
      {/* SWAP BUTTON */}
      <button className="w-full py-5 rounded-[1.5rem] bg-cyan-500 text-zinc-950 font-black text-lg shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:bg-cyan-400 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group/swap">
        <Zap size={20} className="fill-zinc-950 group-hover:scale-125 transition-transform" />
        Review Swap
      </button>
    </div>
  );
