      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start mb-24 gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              <div className={`flex items-center p-1.5 bg-zinc-900/50 backdrop-blur-sm border transition-all duration-500 rounded-2xl ${
                status === 'success' ? 'border-emerald-500/50 shadow-[0_0_30px_rgba(16,185,129,0.15)] bg-emerald-500/5' : 
                status === 'idle' ? 'border-white/10 hover:border-cyan-500/40 focus-within:border-cyan-500/50 focus-within:shadow-[0_0_20px_rgba(6,182,212,0.1)]' : 'border-white/10 opacity-70'
              }`}>
                <input 
                  type="email" 
                  value={email}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 gap-6 mt-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://github.com/zonafirman" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-zinc-900/50 border border-white/5 text-zinc-400 hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400 transition-all group">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-110 transition-transform">
