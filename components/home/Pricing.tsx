        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
          ...
          >
            ...
            <ul className="space-y-4 mb-10">
              {['Next.js 15 & Tailwind v4 Setup', 'Framer Motion Animations', 'Basic UI Components', 'Standard Auth Modal'].map((feature, i) => (
              ...
              {['Zustand Global State', 'Viem/Wagmi Smart Contract Logic', 'Pro Dashboard Architecture', 'AI Intent Engine'].map((feature, i) => (
          ...
          {/* PRO CARD (Paid/Commercial) - Taller & Highlighted */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-6 pb-6 border-b border-white/5 relative z-10">Everything you need to launch a production-ready dApp.</p>
            ...
            <ul className="space-y-4 mb-10 relative z-10">
              ...
              {['Zustand Global State Management', 'Viem/Wagmi Smart Contract Hooks', 'Pro Dashboard Architecture (SPA)', 'AI Intent Engine (Search & Swap)', 'Advanced MEV Protection UI', 'Premium Figma Files', 'Lifetime Updates'].map((feature, i) => (
                <li key={i} className="flex items-center gap-3 text-sm font-medium text-zinc-300">
